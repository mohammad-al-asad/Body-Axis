        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-12">
          ...
          <div className="w-full max-w-[320px] bg-[#131B2F]/60 backdrop-blur-md rounded-2xl p-8 border border-[#1E293B] shadow-[0_0_30px_rgba(37,99,235,0.08)] relative">
            ...
            <div className="text-center mb-8">
              <h2 className="text-white font-bold text-[18px] mb-2 tracking-wide">Secure Authentication</h2>
            ...
            <form onSubmit={handleSignIn} className="space-y-5">
              ...
              <div className="flex justify-end pt-1">
                <Link to="/forgate-password" className="text-[10px] font-bold text-[#06B6D4] hover:text-white transition-colors tracking-wide">
                  Forgot Password?
                </Link>
              </div>
